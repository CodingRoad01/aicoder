  ...
  return (
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        ...
        <link rel="icon" href="/aicoder-icon.png" />
      ...
      <main className="flex flex-1 w-full flex-col items-center  text-center px-4 mt-8 ">
        ...
        { useUserKey &&(
          ...
          <div className="mt-1 items-center space-x-3">
            <span className="text-slate-200 tooltip text-blue-500" data-tooltip="1.本网站仅提供学习交流使用；2.请自觉遵守法律法规，科学上网；3.该网站不对任何与生成内容有关的法律责任负责。">
			 隐私说明
            </span>
        ...
        <p></p>
		<p></p>
         <p className="text-slate-500 items-center"><br/>编程无难事，简单可依赖</p>
        <br/>  
